...
### Geral
- [ ] Otimizar a cena  
- [ ] Configurar a oclusão dinâmica (opcional)
- [ ] Verificar se os objetos que deveriam ser estáticos já estão definidos como estáticos  

### Finalização
- [ ] Revisão geral do enunciado  
- [ ] Revisão geral das interações na cena  
- [ ] Revisão geral do código  
- [ ] Documentação (comentários no código e README)
- [ ] Justificar a não utilização do pacote Cinemachine2 (built-in do Unity), e pq fizemos o codigo de mover personagem e camera do zero
